...
class BloqueoArcoAseguradora:
    ...
    def execute(self, aseguradora_id: str, usuario_id: str) -> None:
        ...
        if user.get("aseguradora_id") != aseguradora_id:
            raise BusinessRuleError("No puedes aplicar bloqueo ARCO a un usuario de otra aseguradora")
            
        self.user_repo.bloquear_por_arco(usuario_id)
        
        # Aquí también deberíamos registrar en el AuditLog

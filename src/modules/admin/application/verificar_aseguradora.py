...
class VerificarAseguradoraUseCase:
    ...
    def execute(self, admin_id: str, aseguradora_id: str) -> AseguradoraTenant:
        ...
        if tenant.estatus_comercial == "Activo":
            raise BusinessRuleError("La aseguradora ya se encuentra verificada y activa.")
        
        old_estatus = tenant.estatus_comercial
        tenant.estatus_comercial = "Activo"
        ...
        self.audit_repo.append(AuditLog(
            ...
            accion_realizada="VERIFICAR_ASEGURADORA",
            evento_modulo="ASEGURADORAS",
            metadata_context={"old_estatus": old_estatus, "new_estatus": "Activo"},

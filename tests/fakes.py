"""Repositorios y adaptadores en memoria para pruebas (sin BD)."""
...
class FakeAjustadorChecker:
    """Implementa AjustadorCheckerPort.existe_y_activo."""
...
class FakeTallerChecker:
    """Implementa TallerCheckerPort.existe."""
